...
static void button_savelevel_event(kiss_button* button, SDL_Event* e,int* draw)
{
	if (kiss_button_event(button, e, draw))
	{
		...
		char path[MAX_PATH];
		GetSubDirectoryPath(path, "editor\\testsave.sav");
...
int main_x()
{
	...
	GetSubDirectoryPath(path, "kiss\\kiss_delete_normal.png");
	img_delete_normal.w = 16;
	img_delete_normal.h = 16;
	img_delete_normal.magic = KISS_MAGIC;
	img_delete_normal.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_delete_prelight;
	GetSubDirectoryPath(path, "kiss\\kiss_delete_prelight.png");
	img_delete_prelight.w = 16;
	img_delete_prelight.h = 16;
	img_delete_prelight.magic = KISS_MAGIC;
	img_delete_prelight.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_clean_normal;
	GetSubDirectoryPath(path, "kiss\\kiss_clean_normal.png");
	img_clean_normal.w = 16;
	img_clean_normal.h = 16;
	img_clean_normal.magic = KISS_MAGIC;
	img_clean_normal.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_clean_prelight;
	GetSubDirectoryPath(path, "kiss\\kiss_clean_prelight.png");
	img_clean_prelight.w = 16;
	img_clean_prelight.h = 16;
	img_clean_prelight.magic = KISS_MAGIC;
	img_clean_prelight.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_add_normal;
	GetSubDirectoryPath(path, "kiss\\kiss_add_normal.png");
	img_add_normal.w = 16;
	img_add_normal.h = 16;
	img_add_normal.magic = KISS_MAGIC;
	img_add_normal.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_add_prelight;
	GetSubDirectoryPath(path, "kiss\\kiss_add_prelight.png");
	img_add_prelight.w = 16;
	img_add_prelight.h = 16;
	img_add_prelight.magic = KISS_MAGIC;
	img_add_prelight.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_player;
	GetSubDirectoryPath(path, "kiss\\kiss_player32.png");
	img_player.w = 32;
	img_player.h = 32;
	img_player.magic = KISS_MAGIC;
	img_player.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\kiss_none32.png");
	img_none.w = 32;
	img_none.h = 32;
	img_none.magic = KISS_MAGIC;
	img_none.image = IMG_LoadTexture(editor_renderer, path);
	
	GetSubDirectoryPath(path, "kiss\\kiss_creature32.png");
	img_creature.w = 32;
	img_creature.h = 32;
	img_creature.magic = KISS_MAGIC;
	img_creature.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\kiss_castle32.png");
	img_castle.w = 32;
	img_castle.h = 32;
	img_castle.magic = KISS_MAGIC;
	img_castle.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_weather;
	GetSubDirectoryPath(path, "kiss\\kiss_weather32.png");
	img_weather.w = 32;
	img_weather.h = 32;
	img_weather.magic = KISS_MAGIC;
	img_weather.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\kiss_trigger32.png");
	img_trigger.w = 32;
	img_trigger.h = 32;
	img_trigger.magic = KISS_MAGIC;
	img_trigger.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_rock;
	GetSubDirectoryPath(path, "kiss\\kiss_rock32.png");
	img_rock.w = 32;
	img_rock.h = 32;
	img_rock.magic = KISS_MAGIC;
	img_rock.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_spell;
	GetSubDirectoryPath(path, "kiss\\kiss_spell32.png");
	img_spell.w = 32;
	img_spell.h = 32;
	img_spell.magic = KISS_MAGIC;
	img_spell.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_spellB;
	GetSubDirectoryPath(path, "..\\kiss\\kiss_spellB32.png");
	img_spellB.w = 32;
	img_spellB.h = 32;
	img_spellB.magic = KISS_MAGIC;
	img_spellB.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_search;
	GetSubDirectoryPath(path, "kiss\\kiss_search.png");
	img_search.w = 16;
	img_search.h = 16;
	img_search.magic = KISS_MAGIC;
	img_search.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-01-goat.png");
	img_type05_01.w = 32;
	img_type05_01.h = 32;
	img_type05_01.magic = KISS_MAGIC;
	img_type05_01.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-02-bee.png");
	img_type05_02.w = 32;
	img_type05_02.h = 32;
	img_type05_02.magic = KISS_MAGIC;
	img_type05_02.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-03-worm.png");
	img_type05_03.w = 32;
	img_type05_03.h = 32;
	img_type05_03.magic = KISS_MAGIC;
	img_type05_03.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-04-archer.png");
	img_type05_04.w = 32;
	img_type05_04.h = 32;
	img_type05_04.magic = KISS_MAGIC;
	img_type05_04.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-09-skeleton.png");
	img_type05_09.w = 32;
	img_type05_09.h = 32;
	img_type05_09.magic = KISS_MAGIC;
	img_type05_09.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-13-fly.png");
	img_type05_13.w = 32;
	img_type05_13.h = 32;
	img_type05_13.magic = KISS_MAGIC;
	img_type05_13.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type05-0D-townie.png");
	img_type05_0D.w = 32;
	img_type05_0D.h = 32;
	img_type05_0D.magic = KISS_MAGIC;
	img_type05_0D.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-01-explosion.png");
	img_type0A_01.w = 32;
	img_type0A_01.h = 32;
	img_type0A_01.magic = KISS_MAGIC;
	img_type0A_01.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-06-fire.png");
	img_type0A_06.w = 32;
	img_type0A_06.h = 32;
	img_type0A_06.magic = KISS_MAGIC;
	img_type0A_06.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-16-vortex.png");
	img_type0A_16.w = 32;
	img_type0A_16.h = 32;
	img_type0A_16.magic = KISS_MAGIC;
	img_type0A_16.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-27-mana.png");
	img_type0A_27.w = 32;
	img_type0A_27.h = 32;
	img_type0A_27.magic = KISS_MAGIC;
	img_type0A_27.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-3B-smooke2.png");
	img_type0A_3B.w = 32;
	img_type0A_3B.h = 32;
	img_type0A_3B.magic = KISS_MAGIC;
	img_type0A_3B.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-3C-smooke.png");
	img_type0A_3C.w = 32;
	img_type0A_3C.h = 32;
	img_type0A_3C.magic = KISS_MAGIC;
	img_type0A_3C.image = IMG_LoadTexture(editor_renderer, path);

	GetSubDirectoryPath(path, "kiss\\type0A-1D-path.png");
	img_type0A_1D.w = 32;
	img_type0A_1D.h = 32;
	img_type0A_1D.magic = KISS_MAGIC;
	img_type0A_1D.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_type2D;
	GetSubDirectoryPath(path, "kiss\\type2D.png");
	img_type2D.w = 32;
	img_type2D.h = 32;
	img_type2D.magic = KISS_MAGIC;
	img_type2D.image = IMG_LoadTexture(editor_renderer, path);


	kiss_image img_check00;
	GetSubDirectoryPath(path, "kiss\\check-00.png");
	img_check00.w = 32;
	img_check00.h = 32;
	img_check00.magic = KISS_MAGIC;
	img_check00.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_check03;
	GetSubDirectoryPath(path, "kiss\\check-03.png");
	img_check03.w = 32;
	img_check03.h = 32;
	img_check03.magic = KISS_MAGIC;
	img_check03.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_check05;
	GetSubDirectoryPath(path, "kiss\\check-05.png");
	img_check05.w = 32;
	img_check05.h = 32;
	img_check05.magic = KISS_MAGIC;
	img_check05.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_check07;
	GetSubDirectoryPath(path, "kiss\\check-07.png");
	img_check07.w = 32;
	img_check07.h = 32;
	img_check07.magic = KISS_MAGIC;
	img_check07.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_check08;
	GetSubDirectoryPath(path, "kiss\\check-08.png");
	img_check08.w = 32;
	img_check08.h = 32;
	img_check08.magic = KISS_MAGIC;
	img_check08.image = IMG_LoadTexture(editor_renderer, path);

	kiss_image img_check09;
	GetSubDirectoryPath(path, "kiss\\check-09.png");
	img_check09.w = 32;
	img_check09.h = 32;
	img_check09.magic = KISS_MAGIC;
	img_check09.image = IMG_LoadTexture(editor_renderer, path);
